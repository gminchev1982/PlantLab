...
public class ProductServiceImpl implements ProductService {
    ...
    /*@Override
    public boolean edit(ProductServiceEditModel productServiceEditModel) throws ProductNotFoundException {

        if (productValidationService.isValidProductServiceEditModel(productServiceEditModel)) {
            ProductEntity product = this.productRepository.findById(productServiceEditModel.getId())
                    .orElseThrow(() -> new ProductNotFoundException());

            ProductEntity productEntity = this.modelMapper.map(productServiceEditModel, ProductEntity.class);
